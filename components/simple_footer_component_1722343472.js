...
*/
Vue.component("simple_footer_component_1722343472", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockMetrix - Blockchain Metadata Analytics
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain deep insights into blockchain data with BlockMetrix. Our platform analyzes rich metadata from transactions, contracts, and more to help you stay ahead of the curve. Built by blockchain enthusiasts for the blockchain community.
                    </div>
                </div>
            </div>
        </footer> 
